...
echo "[Info] To extract all translation keys from ./src directory and add into ./app/Resources/translations directory for pl locale:"
echo "[Info] bin/console translation:extract pl --keep --dir=./src --output-dir=./app/Resources/translations"
